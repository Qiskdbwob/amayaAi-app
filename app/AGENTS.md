...
- `src/main/java/com/amaya/intelligence/impl/local/`: local AI service, browser runtime, local runtime integrations, Agent history clearing, and model-summary context compression.
